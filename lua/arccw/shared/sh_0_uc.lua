...
elseif SERVER then
    ...
    net.Receive("ArcCW_UC_CustColor", function(len, ply)
        ...
        net.Start("ArcCW_UC_CustColor")
            ...
            if enabled then
                net.WriteColor(Color(owner:GetInfoNum("arccw_uc_custcolor_1_r", 255), owner:GetInfoNum("arccw_uc_custcolor_1_g", 255), owner:GetInfoNum("arccw_uc_custcolor_1_b"), 255), false)
                net.WriteColor(Color(owner:GetInfoNum("arccw_uc_custcolor_2_r", 255), owner:GetInfoNum("arccw_uc_custcolor_2_g", 255), owner:GetInfoNum("arccw_uc_custcolor_2_b"), 255), false)
            end
        net.SendOmit(ply)
    end)
end
