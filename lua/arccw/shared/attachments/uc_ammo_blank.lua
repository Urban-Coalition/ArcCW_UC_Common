...
att.Description = [[Cartridges sealed without a solid projectile, but otherwise performs identically. Used when the muzzle report of a gunshot is necessary without the bullet, such as in filming, ceremonies, sports, and combat training.
